...
from cwrubacktest.broker.portfolio.portfolio import Portfolio
from cwrubacktest.broker.transaction.transaction import Transaction
...
class SimulatedBroker():
    ...
    def _set_base_currency(self, base_currency):
        ...
        currency is currently not supported by cwrubacktest.
